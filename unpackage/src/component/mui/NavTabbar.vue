        ...
        methods: {
            ...
            switch: function(index) {
                ...
                if(index === 3) {
                    ...
                    let id = 'main';
                    let url = '../../commonpage/index/main.html';
...
<style scoped>
    ...
    .nav-bar-tab .nav-tab-item:nth-child(2) .jxddicon {
        font-size: 20px;
        font-weight: 600;
