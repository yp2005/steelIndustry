		...
		<div class="mui-scroll-wrapper releaseCard">
			<div class="mui-scroll">
				...
				<template v-if="authStep == 0">
					...
					<div class="bottomBtn">
						<a style="width:100%;" href="javascript:void(0)" @tap="stepNext(1)">下一步</a>
					</div>
				</template>
				<template v-if="authStep == 1">
					...
					<div class="bottomBtn">
						<a style="width:100%;" href="javascript:void(0)" @tap="stepNext(2)">提交审核</a>
					</div>
				</template>
			</div>
		</div>
		<template v-if="authStep == 2">
			<div class="title backTitleBg"></div>
